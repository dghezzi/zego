...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:0.0/255.0f green:166.0/255.0f blue:147.0/255.0f alpha:1.0f];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:0.0/255.0f green:166.0/255.0f blue:147.0/255.0f alpha:1.0f];
	}
}
