 ...
 * @author Lu
 */
public class ExportcashControllerBean extends EntityControllerBean<Integer, Exportcash> {

    public ExportcashControllerBean(DAOFactory f) {
        super(f, Exportcash.class);
    }
