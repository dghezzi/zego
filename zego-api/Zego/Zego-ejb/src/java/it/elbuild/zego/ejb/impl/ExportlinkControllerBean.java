 ...
 * @author Lu
 */
public class ExportlinkControllerBean extends EntityControllerBean<Integer, Exportlink> {

    public ExportlinkControllerBean(DAOFactory f) {
        super(f, Exportlink.class);
    }
